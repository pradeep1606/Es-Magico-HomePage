...
const HeroSection = () => {
    return (
        <div className="w-[70%] md:h-[480px] h-auto flex flex-col justify-center items-center md:mx-[247px] md:mt-[191px] mt-auto mx-auto" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="800">
            ...
            <div className='text-[#538CFF] mt-10 md:mt-[191px] md:mb-0 mb-10 flex flex-col items-center space-y-0'  data-aos="fade-up">
