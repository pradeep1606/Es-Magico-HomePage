...
const Sas = () => {
  return (
    <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="800" className="bg-[#f7f7f7] md:rounded-[30px] rounded-xl mx-[13px] md:mx-[120px] mt-[60px] p-10 md:p-[50px]">
      <div className="">
