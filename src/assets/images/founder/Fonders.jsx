...
const Fonders = () => {
  return (
    ...
    <div className=" h-screen w-full bg-white flex flex-col items-center justify-center">
        <div className="  w-[90%] h-full flex items-center justify-center flex-col">
            <div className=" h-fit flex justify-center items-center gap-[5vw] py-5 px-5 w-[90%] rounded-2xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] ">
                ...
                <img src="/public/images/Rectangle 72.png" alt="An image" className=" h-full w-full object-cover object-center " />
                </div>
                <div className=" h-[30vh] w-[20vw] bg-zinc-800 rounded-lg overflow-hidden ">
                <img src="/public/images/Rectangle 73.png" alt="An image" className=" h-full w-full object-cover object-center " />
                </div>
                <div className=" h-[30vh] w-[20vw] bg-zinc-800 rounded-lg overflow-hidden ">
                <img src="/public/images/Rectangle 73.png" alt="An image" className=" h-full w-full object-cover object-center " />
                </div>
    ...
    <div className=" h-fit w-[90%] flex items-center p-5 justify-center">
        <div className=" card h-[40vh] py-10 px-5 w-[18vw]  rounded-3xl ">
        ...
        <div className=" h-[40vh] py-10 px-5 w-[15vw] bg-white rounded-3xl ">
        <img src="/public/images/Vector-3.png" alt="An image" className=" " />
            <h2 className=" text-lg font-semibold ">Superfast Pace of Execution</h2>
        </div>
        <div className=" h-[40vh] py-10 px-5 w-[15vw] bg-white rounded-3xl ">
        <img src="/public/images/Vector2.png" alt="An image" className=" " />
            <h2 className=" text-lg font-semibold ">AI Expertise</h2>
        </div>
        <div className=" h-[40vh] py-10 px-5 w-[15vw] bg-white rounded-3xl ">
        <img src="/public/images/Vector3.png" alt="An image" className=" " />
